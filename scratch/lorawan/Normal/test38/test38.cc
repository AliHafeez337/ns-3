/*
 * Scenario 2 - Simulation 1 - Normal - DeliveryRatio: 
 1 ED, 2GW, 1NS, ?60packet
...
STORY:
 Both GWs receive packet (search line "GatewayLorawanMac:Receive(0x")
...
main(int argc, char* argv[])
{
    ...
    allocator->Add(Vector(1000, 0, 0)); // ED
